    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="bg-stone-800 w-full max-w-lg rounded-lg shadow-2xl p-6 border-4 border-stone-600 relative">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-3xl md:text-4xl text-green-400 uppercase tracking-widest drop-shadow-md">Impostazioni</h2>
          <button onClick={onClose} className="bg-stone-600 hover:bg-stone-500 text-white px-4 py-1 text-xl border-b-4 border-stone-800 active:border-b-0 active:translate-y-1 transition-all">X</button>
        </div>
        ...
        <div className="space-y-6">
          <section>
            ...
            <select
              ...
              className="w-full bg-stone-900 text-lg text-white border-4 border-stone-700 p-3 focus:border-green-500 outline-none uppercase"
            >
          ...
          <section className="space-y-2">
            ...
            <ToggleBtn 
              ...
              active={showVillagers} 
              onClick={() => setShowVillagers(!showVillagers)} 
            />
            <ToggleBtn 
              label="Natural Baby" 
              active={showRealBaby} 
          ...
          <button
            onClick={resetAll}
            className="w-full bg-red-700 hover:bg-red-600 text-white text-xl py-3 border-b-4 border-red-900 active:border-b-0 active:translate-y-1 transition-all uppercase tracking-wider"
          >
            Reset Progressi
          </button>
        </div>
