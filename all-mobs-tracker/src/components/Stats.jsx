    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="bg-stone-800 w-full max-w-4xl rounded-lg shadow-2xl p-6 md:p-8 border-4 border-stone-600 overflow-y-auto max-h-[90vh]">
        <div className="flex justify-between items-center mb-8 border-b-4 border-stone-700 pb-4">
          <h2 className="text-3xl md:text-4xl text-blue-400 uppercase tracking-widest ">Statistiche</h2>
        ...
        <div className="bg-stone-900 p-6 border-4 border-stone-700 mb-8 text-center">
          <h3 className="text-2xl text-stone-300 uppercase  mb-2">Completamento Globale (Tutti i mob esistenti)</h3>
          <div className="text-5xl text-blue-400  mb-4">{stats.tracked} / {stats.total}</div>
          ...
          <p className="mt-2 text-xl ">{stats.percentage}%</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Categorie */}
          <div>
            <h3 className="text-2xl text-amber-500 uppercase  mb-4 border-b-2 border-stone-600 pb-2">Per Categoria</h3>
            <div className="space-y-4">
              {stats.complexStats.map(stat => stat.total > 0 && (
                <div key={stat.label} className="bg-stone-900/60 p-3 border-2 border-stone-700">
                  <div className="flex justify-between  uppercase text-stone-300">
          ...
          {/* Suffissi */}
          <div>
            <h3 className="text-2xl text-purple-400 uppercase  mb-4 border-b-2 border-stone-600 pb-2">Per Suffisso (Baby, Pet, ecc)</h3>
            <div className="space-y-4">
